...
for model in models:
    ...
    DCdf_singleBH["BH1"] = DCdf["MASSDC1"]*DCdf["MASKDCBH1"]
    DCdf_singleBH["CP2"] = DCdf["MASSDC2"]*DCdf["MASKDCBH1"]
    DCdf_singleBH["SA1"] = DCdf["SEMIMAJORAXISDC"]*DCdf["MASKDCBH1"]

    #Systems which secondary is BH
    DCdf_singleBH["BH2"] = DCdf["MASSDC2"]*DCdf["MASKDCBH2"]
    DCdf_singleBH["CP1"] = DCdf["MASSDC1"]*DCdf["MASKDCBH2"]
    DCdf_singleBH["SA2"] = DCdf["SEMIMAJORAXISDC"]*DCdf["MASKDCBH2"]
...
##########
    ...
    print(max(DCdf["SEMIMAJORAXISDC"]))
    print(max(SPdf["SEMIMAJORAXISSP"]))
